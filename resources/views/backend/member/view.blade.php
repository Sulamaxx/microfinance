    ...
    <div class="row">
        <div class="col-md-4 col-lg-3">
            <ul class="nav flex-column nav-tabs settings-tab" role="tablist">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('members.edit', $member->id) }}"><i
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>{{ _lang('Customer Id') }}</td>
                                    <td>{{ $member->customer_id }}</td>
                                </tr>
                                <tr>
                                    <td>{{ _lang('Civil Status') }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $member->name_with_initial }}</td>
                                </tr>
                                <tr>
                                    <td>{{ _lang('NIC') }}</td>
                                    <td>{{ $member->nic }}</td>
                        ...
                        <div class="card-header">
                            <span class="header-title">{{ _lang('Sponser Details') }}</span>
                        </div>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <td>{{ _lang('Mobile 1') }}</td>
                                <td>{{ $member->sponsor->mobile1 }}</td>
                                </tr>
                                </tr>
                                <td>{{ _lang('Mobile 2') }}</td>
                                <td>{{ $member->sponsor->mobile2 }}</td>
                                </tr>
                                <tr>
                                    <td>{{ _lang('Address') }}</td>
                                    <td>{{ $member->sponsor->address1 . ', ' . $member->sponsor->address2 }}</td>
                                </tr>
                                <tr>
                                    <td>{{ _lang('City') }}</td>
                                    <td>{{ $member->sponsor->city }}</td>
                                </tr>
                                <tr>
                                    <td>{{ _lang('State') }}</td>
                                    <td>{{ $member->sponsor->state }}</td>
                                </tr>
                                <tr>
                                    <td>{{ _lang('Zip') }}</td>
                                    <td>{{ $member->sponsor->zip }}</td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="profile_picture text-center">
                                        <span class="font-weight-bold">Signature</span>
                                        <img src="{{ profile_picture($member->sponsor->photo) }}" class="thumb-image-md">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="profile_picture text-center">
                                        <img src="{{ profile_picture($member->sponsor->doc_image1) }}"
                                            class="thumb-image-md">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="profile_picture text-center">
                                        <img src="{{ profile_picture($member->sponsor->doc_image2) }}"
                                            class="thumb-image-md">
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="loans_table" class="table table-bordered data-table">
                                ...
                                <tbody>
                                    @foreach ($member->loans != null && count($member->loans) > 0 && $member->loans as $loan)
                                        <tr>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered data-table">
                                ...
                                <tbody>
                                    @foreach ($member->documents != null && count($member->documents) > 0 && $member->documents as $document)
                                        <tr>
                                            <td>{{ $document->name }}</td>
                                            <td><a target="_blank"
                                            ...
                                            <td class="text-center">
                                                <span class="dropdown">
                                                    ...
                                                    <form action="{{ route('member_documents.destroy', $document->id) }}"
                                                        method="post">
                                                        {{ csrf_field() }}
                                                        <input name="_method" type="hidden" value="DELETE">

                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a href="{{ route('member_documents.edit', $document->id) }}"
